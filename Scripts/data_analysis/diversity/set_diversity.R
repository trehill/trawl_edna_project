...
plot <- plot(euler(data_long, by = list(set_number)), legend = TRUE)
plot 
...
#need to change labels + order from small -> large 

plot(euler(data_long, by = list(set_number)), legend = TRUE) 
