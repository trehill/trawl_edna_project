...
ggsave("./Outputs/traits/length/ind_length_his.png", 
       plot = plot,
...
ggsave("./Outputs/traits/max_length/trawleDNA_density_max.png", 
       plot = plot,
       width = 10, height = 6, units = "in")
...
ggsave("./Outputs/traits/max_length/all_length_dist.png", 
       plot = plot,
       width = 10, height = 6, units = "in")
...
ggsave("./Outputs/traits/max_length/trawl_edna_2.png", 
       plot = plot,
...
ggsave("./Outputs/traits/max_length/length_bymethod_stack.png", 
       plot = plot,
       width = 12, height = 7, units = "in")
...
ggsave("./Outputs/traits/max_length/max_length_density.png", 
       plot = plot,
       width = 12, height = 7, units = "in")
