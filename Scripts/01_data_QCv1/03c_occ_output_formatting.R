...
write.csv(occprob_by_sample, "./Outputs/occupancy_modelling/royle_link/occprob_by_sample.csv")
...
write.csv(ASV_LowOccRemoved, "./Processed_data/eDNA/12s/12s_u/asv/matrix/clean_data/data12su_asvmatrix_nc_lor.csv")
